...
const BookingRegisterUpdate = ({ copyId, companyId }) => {
  // essentials
  ...
  const handleAddRecordToLocal = () => {
    setData((prevData) => ({
      ...
      registerData: [...prevData.registerData, prevData.initialRegisterData],
    }));
   setAddRow(false)
  };

  const fetchDetails = async () => {
    await fetchCopyDetails("bookingregister", copyId, setData);
  };
  const navigate = useNavigate();
  const handleUpdate = () => {
    updateCopy("bookingregister",data,companyId, copyId, setIsLoading, navigate)
  }
  useEffect(() => {
    fetchDetails();
  }, []);
  ...
  return (
    <div className="bg-white p-3">
      ...
      <div className="pt-3 overflow-x-auto">
              ...
              <tr>
                ...
                <td className="border border-black px-2 py-1">
                  <input
                    ...
                    onChange={(e) =>
                      handleMoreNestedChange(
                        "initialRegisterData.number_of_packages",
                        e.target.value,
                        ""
                      )
                    }
                ...
                <td className="border border-black px-2 py-1">
                  <input
                    ...
                    onChange={(e) =>
                      handleMoreNestedChange(
                        "initialRegisterData.destination",
                        e.target.value,
                        ""
                      )
                    }
                ...
                <td className="border border-black px-2 py-1">
                  <input
                    ...
                    onChange={(e) =>
                      handleMoreNestedChange(
                        "initialRegisterData.bill_amount",
                        e.target.value,
                        ""
                      )
                    }
                ...
                <td className="border border-black px-2 py-1">
                  <input
                    ...
                    onChange={(e) =>
                      handleMoreNestedChange(
                        "initialRegisterData.to_pay_tbb",
                        e.target.value,
                        ""
                      )
                    }
                ...
                <td className="border border-black px-2 py-1">
                  <input
                    ...
                    onChange={(e) =>
                      handleMoreNestedChange(
                        "initialRegisterData.bill_number",
                        e.target.value,
                        ""
                      )
                    }
                ...
                <td className="border border-black px-2 py-1">
                  <input
                    ...
                    onChange={(e) =>
                      handleMoreNestedChange(
                        "initialRegisterData.broker_name",
                        e.target.value,
                        ""
                      )
                    }
                ...
                <td className="border border-black px-2 py-1">
                  <input
                    ...
                    onChange={(e) =>
                      handleMoreNestedChange(
                        "initialRegisterData.challan_number",
                        e.target.value,
                        ""
                      )
                    }
                ...
                <td className="border border-black px-2 py-1">
                  <input
                    ...
                    onChange={(e) =>
                      handleMoreNestedChange(
                        "initialRegisterData.lorry_number",
                        e.target.value,
                        ""
                      )
                    }
        ...
        <button
          className="bg-yellow-500 rounded p-1 w-full text-white mt-3"
          onClick={() => {
            if(addRow){
              handleAddRecordToLocal();
            }else{
              setAddRow(true)
            }
          }}
        >
          {addRow == true ? 'Submit' : 'Add Row'}
        </button>
      </div>

      <button
        className="bg-blue-800 hover:bg-blue-600 text-white rounded p-2 w-full"
...
export default BookingRegisterUpdate;
